...
public class ClienteMatricesRMI {
    ...
    public static class worker extends Thread{
        ...
        public worker(InterfaceMatricesRMI nodo, String ip, float[][] M){
            this.nodo = nodo;
            this.ip = ip;
            this.M = M;
        }
    ...
    public static void main(String[] args) throws Exception {       
        String[] IPnodos = {"10.0.0.5", "10.0.0.6", "10.0.0.7", "10.0.0.8"};
        ...
        worker nodo1 = new worker(nodos[0], "localhost", A1);
        worker nodo2 = new worker(nodos[1], "localhost", A2);
        worker nodo3 = new worker(nodos[2], "localhost", A3);
        worker nodo4 = new worker(nodos[3], "localhost", A4);
