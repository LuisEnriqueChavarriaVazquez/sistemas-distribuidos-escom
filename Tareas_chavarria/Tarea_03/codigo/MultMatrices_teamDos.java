...
public class MultMatrices_teamDos {
    ...
    */
    ...
    public static class workerMatrixMul extends Thread{
        ...
        */
        String ipAdd;
        int nodo;      
        double[][] tempHelperA = new double[N/2][N];
        double[][] tempHelperB = new double[N/2][N];
        ...
        */
        ...
        public void run(){  
            try {
                ...
                Socket conexion = new Socket(this.ipAdd, 50000 + this.nodo);
                ...
                //Parametros ==> salida, tempHelper(A,B)//
                try{
                    enviarMatriz(salida, tempHelperA);
                    enviarMatriz(salida, tempHelperB);
    ...
    public static void main(String[] args) {
        ...
        if(args.length == 1){
            if(nodo == 0 || nodo == 1 || nodo == 2 || nodo == 3){
                ...
                System.out.println("Ingrese el caso [puede ser el 8 o 1000] == ");
                int casoNumero = myInput.nextInt();
                System.out.println(casoNumero);
                myInput.close();
                */
        ...
        if(nodo == 0){
            ...
            */
            ...
            try {
                ...
                //Def para A y B, con tempHelperC
                double[][] A = new double[N/2][N];
                double[][] B = new double[N/2][N];
                double[][] tempHelperC = new double[N][N];
                ...
                /*
                * Hay que usar el tempHelperC para contenerla
                * y multiplicarlas , despues basta con imprimir
                * como se aprecia.
                */
                tempHelperC = multiplicarMatrices(A, B);
                System.out.println("--------------------------------------------------");
                ...
                System.out.println("\nMatriz C");
                System.out.println("--------------------------------------------------");
                imprimirMatriz(tempHelperC);
                try{
                    enviarMatriz(salida, tempHelperC);
                }catch (Exception e){
                    System.out.println (e.getMessage());
                }
    ...
    /*
    *   Los chunks de abajo los usaremos para evitar redundancia
    *   y sobre todo lograr trabajr de manera ordena durante el desarrollo
    *   de esta tarea, favor de evitar repetir lineas de código si ya hay esta aqui
    *   abajo definido.

    *   Nota Luis Chavarria, se hizo un pequeña modificación pero es mínima.
    */
