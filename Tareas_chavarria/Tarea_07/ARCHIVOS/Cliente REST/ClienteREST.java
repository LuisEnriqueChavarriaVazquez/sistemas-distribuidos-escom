...
/*
	debemos importar las siguientes librerias para...
	el manejo de las urls que necesitamos usar, del
	mismo modo podemos 
*/
import java.net.URL;
...
class ClienteREST{
	...
	public static void Alta(Usuario usuario) throws Exception{
		URL url = new URL("http://20.25.16.80:8080/Servicio/rest/ws/alta_usuario");
	...
	public static void Consulta(int id_usuario) throws Exception{
		...
		URL url = new URL("http://20.25.16.80:8080/Servicio/rest/ws/consulta_usuario");
		...
		if(conexion.getResponseCode() == 200){
			...
			while((respuesta = br.readLine()) != null){
				...
				System.out.println("\n______________________________________________________________________\n");
				System.out.println("*CORREO: " + usuario_consultado.email);
				System.out.println("*NOMBRE: " + usuario_consultado.nombre);
				System.out.println("*APELLIDO PATERNO: " + usuario_consultado.apellido_paterno);
				System.out.println("*APELLIDO MATERNO: " + usuario_consultado.apellido_materno);
				System.out.println("*FECHA NACIMIENTO: " + usuario_consultado.fecha_nacimiento);
			...
			sc.nextLine();
			if(opc2 == 's'){
				System.out.println("Ingrese la información correspondiente:  ");
	...
	public static void Modificar(Usuario usuario) throws Exception{
		URL url = new URL("http://20.25.16.80:8080/Servicio/rest/ws/modifica_usuario");
	...
	public static void Borrar(int id_usuario) throws Exception{
		URL url = new URL("http://20.25.16.80:8080/Servicio/rest/ws/borra_usuario");
